...
SECRET_KEY = 'django-insecure-(eg$c28mfl!rso$o!&l41444)ktrn!)@&xh@3gox@c)s3ag*6('
...
MONGODB_NAME = os.getenv('MONGODB_NAME', 'dhl_leave_management')
...
# Login/Logout URLs
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'dashboard'  # or whatever your main page is
